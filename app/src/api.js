...
const _real = {
  ...
  adminDeleteOrder: (id) => req(`/api/admin/orders/${id}`, { method: 'DELETE' }),
...
export const api = {
  ...
  adminDeleteOrder: withFallback(_real.adminDeleteOrder, () => Promise.reject(new Error('Butuh backend untuk fitur ini'))),
